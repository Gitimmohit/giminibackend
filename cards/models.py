...
class Quiz(models.Model): 
    ...
    age_grup     = models.IntegerField(blank=True , null=True , verbose_name='age_group')
    age_to       = models.IntegerField(blank=True , null=True , verbose_name='age_to')
...
class Wallet(models.Model):
    ...
    earn_amount = models.DecimalField(max_digits=100, decimal_places=2, default=0.00)
